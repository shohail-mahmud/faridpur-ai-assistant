...
export function getLocalResponse(query: string): string {
  ...
  // Greetings
  if (/^(hi|hello|হাই|হ্যালো|হেলো|আসসালামু আলাইকুম|সালাম|নমস্কার|প্রণাম|hey|hola)$/i.test(q.trim())) {
    return `আসসালামু আলাইকুম! 👋\n\nআমি ফরিদপুর জিলা স্কুলের AI সহকারী। আমি এই স্কুল সম্পর্কে যেকোনো প্রশ্নের উত্তর দিতে পারি। কীভাবে সাহায্য করতে পারি?`;
  }
  
  // Thank you
  if (/ধন্যবাদ|থ্যাংক|thanks|thank you|শুকরিয়া/i.test(q)) {
    return `আপনাকে স্বাগতম! 😊 আরও কিছু জানতে চাইলে জিজ্ঞাসা করুন।`;
  }
